...
public class ItemTrafficLightControlBox extends BlockItem {

    public ItemTrafficLightControlBox(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> tooltipAdder, TooltipFlag flag) {
        ...
        if (InputConstants.isKeyDown(window, InputConstants.KEY_LSHIFT) || InputConstants.isKeyDown(window, InputConstants.KEY_RSHIFT)) {
            tooltipAdder.accept(Component.translatable("trafficcontrol.tooltip.trafficbox").withStyle(ChatFormatting.GRAY));
        } else {
